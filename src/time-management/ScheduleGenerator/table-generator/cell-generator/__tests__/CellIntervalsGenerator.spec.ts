...
describe(CellIntervalsGenerator.name, () => {
  let unitUnderTest: CellIntervalsGenerator;
  let sameDayIntervalMapper: SameDayIntervalMapper;
  ...
  it('should generate all cells', () => {
    ...
    for (let i = 0; i < result.length; i++) {
      expect(sameDayIntervalMapper.mapToString(result[i])).toEqual(allCellsInStringFormat[i]);
    }
  });
});
