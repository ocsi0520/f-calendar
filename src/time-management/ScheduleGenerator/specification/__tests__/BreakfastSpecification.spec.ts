...
describe('BreakfastSpecification.check', () => {
  ...
  it('returns true when only one occupied cell (no need for breakfast room)', () => {
    const table = makeTable([makeTableCell(1, [8, 0], [9, 15], [1])]);
